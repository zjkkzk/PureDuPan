...
object SystemNightModeSyncHook {
    private const val BASE_ACTIVITY = BaiduCnHookPoints.BASE_ACTIVITY
    private const val SETTINGS_ACTIVITY = BaiduCnHookPoints.SETTINGS_ACTIVITY
    private const val CHANGE_SKIN_KT = BaiduCnHookPoints.CHANGE_SKIN_KT
    private const val SKIN_LOADER_LISTENER = BaiduCnHookPoints.SKIN_LOADER_LISTENER
    private const val SETTINGS_ITEM_VIEW = BaiduCnHookPoints.SETTINGS_ITEM_VIEW
    ...
    private fun installRefreshTabSkinHook(cl: ClassLoader) {
        ...
        try {
            val mainActivityClassName = currentMainActivityClassName() ?: run {
                ...
                XposedCompat.log("[SystemNightModeSyncHook] MainActivity host capability missing")
                return
            }
    ...
    private fun findDarkSettingItem(activity: Activity): Any? {
        ...
        for (method in clazz.declaredMethods) {
            ...
            if (method.returnType.name != SETTINGS_ITEM_VIEW) continue
            method.isAccessible = true
